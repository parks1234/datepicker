...
import com.hbbcw.zlapp.custom.datepicker.languages.DPLManager;
import com.hbbcw.zlapp.custom.datepicker.themes.DPTManager;
import com.hbbcw.zlapp.custom.datepicker.utils.MeasureUtil;
...
public class DatePicker extends LinearLayout {
    ...
    public void setMode(DPMode mode) {
        if (mode != DPMode.MULTIPLE&&mode != DPMode.TWOSELECT) {
    ...
    public void setyIsshowHoliday(boolean isshowHoliday) {
        monthView.setisshowHoliday(isshowHoliday);
    }
    /**
     * 设置单选监听器
     *
    ...
    public void setOnDateSelectedListener(OnDateSelectedListener onDateSelectedListener) {
        if (monthView.getDPMode() != DPMode.MULTIPLE&&monthView.getDPMode() != DPMode.TWOSELECT) {
            throw new RuntimeException(
